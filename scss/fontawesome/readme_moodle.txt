...
2. SCSS:
  a. Replace the files in this folder (/theme/slboost/scss/fontawesome) with the files in the scss folder.
  b. Copy the LICENSE.txt file from the root to theme/slboost/scss/fontawesome.
  c. Update theme/slboost/thirdpartylibs.xml.
