...
export default class Drawers {
     ...
     *
     * @static
     * @property {String} drawerShow See {@link event:theme_slboost/drawers:show}
     * @property {String} drawerShown See {@link event:theme_slboost/drawers:shown}
     * @property {String} drawerHide See {@link event:theme_slboost/drawers:hide}
     * @property {String} drawerHidden See {@link event:theme_slboost/drawers:hidden}
     */
    static eventTypes = {
        /**
         * An event triggered before a drawer is shown.
         *
         * @event theme_slboost/drawers:show
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that will be opened.
         */
        drawerShow: 'theme_slboost/drawers:show',

        /**
         * An event triggered after a drawer is shown.
         *
         * @event theme_slboost/drawers:shown
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that was be opened.
         */
        drawerShown: 'theme_slboost/drawers:shown',

        /**
         * An event triggered before a drawer is hidden.
         *
         * @event theme_slboost/drawers:hide
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that will be hidden.
         */
        drawerHide: 'theme_slboost/drawers:hide',

        /**
         * An event triggered after a drawer is hidden.
         *
         * @event theme_slboost/drawers:hidden
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that was be hidden.
         */
        drawerHidden: 'theme_slboost/drawers:hidden',
    };
     ...
     * @returns {module:theme_slboost/drawers}
     */
    ...
    openDrawer({focusOnCloseButton = true, setUserPref = true} = {}) {
        ...
        const pendingPromise = new Pending('theme_slboost/drawers:open');
     ...
     */
        ...
        const pendingPromise = new Pending('theme_slboost/drawers:close');
     ...
     *
     * @param {module:theme_slboost/drawers} comparisonInstance
     */
