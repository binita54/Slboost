@theme_slboost
Feature: Course sections selector is not available on slboost theme
  ...
  Scenario Outline: Course sections selector is not available on slboost theme regardless of the course format
