...
/**
 * Creates a navbar for slboost that allows easy control of the navbar items.
 *
 * @package    theme_slboost
 * @copyright  2021 Adrian Greeve <adrian@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class slboostnavbar implements \renderable {
    ...
    public function __construct(\moodle_page $page) {
        ...
        $this->prepare_nodes_for_slboost();
    }

    /**
     * Prepares the navigation nodes for use with slboost.
     */
    protected function prepare_nodes_for_slboost(): void {
        global $PAGE;
    ...
    /**
     * Get all the slboostnavbaritem elements.
     *
     * @return slboostnavbaritem[] SLboost navbar items.
     */
    ...
    /**
     * Removes all navigation items out of this slboost navbar
     */
    ...
    /**
     * Remove a slboostnavbaritem from the slboost navbar.
     *
     * @param  string|int $itemkey An identifier for the slboostnavbaritem
     * @param  int|null $itemtype An additional type identifier for the slboostnavbaritem (optional)
     */
    ...
    /**
     * Removes the action from the last item of the slboostnavbaritem.
     */
